...
class Tests: XCTestCase {
    ...
    func testSimonSequenceItem_Equatable() {
        let itemOne = SimonGameViewModel.SimonSequenceItem(simonColor: .red, time: 1)
        let itemTwo = SimonGameViewModel.SimonSequenceItem(simonColor: .red, time: 1)
        XCTAssertEqual(itemOne, itemTwo)
    }
    
    func testPlayerReady_confirm(){
        let vm = SimonGameViewModel(tickDurationSeconds: 1)
    ...
    func testStartNewGame_sequenceCreation(){
        ...
        let vm = SimonGameViewModel(tickDurationSeconds: 1, sequenceLenght: sequenceLenght)
    ...
    func testCheckPlayer(){
        ...
        let vm = SimonGameViewModel(tickDurationSeconds: 1, sequenceLenght: sequenceLenght, lastMoveDuration: lastMoveDuration)
        let delegate = GameTestDelegate()
        vm.delegate = delegate
 ...
 */
class GameTestDelegate: SimonGameViewControllerDelegate {
